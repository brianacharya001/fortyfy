...
RUN wget https://www-eu.apache.org/dist/tomcat/tomcat-8/v8.5.68/bin/apache-tomcat-8.5.68.tar.gz
RUN tar -xvf apache-tomcat-8.5.68.tar.gz
RUN mv apache-tomcat-8.5.68 /opt/tomcat
RUN ln -s /opt/tomcat/apache-tomcat-8.5.68 /opt/tomcat/latest
